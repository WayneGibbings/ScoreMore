    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white p-4 border-b flex justify-between items-center">
          <h2 className="text-xl font-bold">How to Use HockeyScorer</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            ...
            <p className="mb-4">
              HockeyScorer is an application designed to help you keep track of scores during hockey
              games. It supports two teams and allows you to track individual player scores, game
              history, and provides real-time updates to the scoreboard.
            </p>
          </section>
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>
                In edit mode, you can update the team name and select a color from the dropdown
                menu.
              </li>
              <li>
                Add players by typing their names in the "Add player" field and clicking "Add
                Player".
              </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                The game control button changes based on the current game state, progressing through
                these states:
              </li>
              <ol className="list-decimal pl-5 mt-2 space-y-1">
                <li>
                  <strong>Start Game:</strong> Click to begin a new game when your teams are ready.
                </li>
                <li>
                  <strong>Half Time:</strong> Click to pause the game at halftime.
                </li>
                <li>
                  <strong>Resume Game:</strong> Click to continue playing after halftime.
                </li>
                <li>
                  <strong>End Game:</strong> Click to finish the current game and record it in the
                  history.
                </li>
              </ol>
            </ul>
          ...
          <section>
            ...
            <p className="mb-2">
              HockeyScorer provides different scoring controls depending on whether you're in active
              game mode or edit mode.
            </p>
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Use the hockey and goal emojis (🏑🥅) next to each player's name to add a point.
                  </li>
                  <li>Only active players are displayed and can receive points.</li>
                  <li>
                    Points are immediately added to both the player's score and the team total.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    The minus (-) button appears next to each player to allow removing points if
                    needed.
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    The scoreboard at the top automatically updates as points are added or removed.
                  </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              {' '}
              <li>
                Edit mode is indicated by a blue outline around the team card and a checkmark icon.
              </li>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  Correct scores by adding or removing points (the minus button only appears in edit
                  mode)
                </li>
              </ul>
              <li>Click the checkmark icon to save changes and exit edit mode.</li>
              <li>
                <strong>Note:</strong> Starting a game will automatically save changes and exit edit
                mode for all teams.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Notes are useful for recording important events, player substitutions, or general
                observations.
              </li>
              <li>
                To add a note:
              ...
              <li>
                You can edit or delete notes during the active game by hovering over them and using
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Each player can be set as active or inactive using the toggle button in edit mode.
              </li>
              ...
              <li>
                Use this feature to manage large teams or substitute players without deleting them.
              </li>
            </ul>
          </section>
          <section>
            <h3 className="text-lg font-semibold mb-2">Data Storage</h3>
            <p>Your game data is stored locally in your browser. This means:</p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            ...
            <p>
              If you encounter any issues or have suggestions for improvements, please use the "Send
